...
Note that "priv" size is always 32 bytes, and that KeyGen_internal is called to produce the expanded private key sizes for "Private Key" in the table above.
